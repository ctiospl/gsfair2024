...
async function runStartTask(
  ...
  console.debug(
    'BarcodeReader starting camera with constraints: ',
  ...
  console.debug('BarcodeReader calling getUserMedia')
  ...
  console.debug('BarcodeReader waiting for video element to load')
  await Promise.race([
  ...
  console.debug('BarcodeReader video element loaded')
  ...
  console.debug('BarcodeReader camera ready')
  return {
    type: 'start',
    data: {
      videoEl,
...
export async function start(
  ...
  taskQueue = taskQueue
    ...
    .catch((error: Error) => {
      console.debug(`BarcodeReader starting camera failed with "${error}"`)
...
async function runStopTask(
  ...
  console.debug('BarcodeReader stopping camera')
